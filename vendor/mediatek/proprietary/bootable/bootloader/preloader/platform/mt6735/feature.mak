...
C_OPTION += -DFEATURE_DOWNLOAD_INFO="$(FEATURE_DOWNLOAD_INFO)"
export FEATURE_DOWNLOAD_INFO
endif
...
ifdef CFG_EFUSE_WRITER_CLEAR_PART_DIS
C_OPTION += -DCFG_EFUSE_WRITER_CLEAR_PART_DIS="$(CFG_EFUSE_WRITER_CLEAR_PART_DIS)"
export CFG_EFUSE_WRITER_CLEAR_PART_DIS
endif

ifneq ("$(wildcard $(D_ROOT)/../../../../../../vendor/mediatek/internal/testmode_enable)","")
ifeq ("$(MTK_EFUSE_DOWNGRADE)","yes")
    C_OPTION += -DMTK_EFUSE_DOWNGRADE
endif
endif
...
ifdef CFG_MEMORY_RESERVED_SMALL_GRANULARITY
C_OPTION += -DCFG_MEMORY_RESERVED_SMALL_GRANULARITY="$(CFG_MEMORY_RESERVED_SMALL_GRANULARITY)"
export CFG_MEMORY_RESERVED_SMALL_GRANULARITY
endif
