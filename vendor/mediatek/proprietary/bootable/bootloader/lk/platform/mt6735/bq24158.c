...
{
    int i=0;
dprintf(CRITICAL,"[bq24158_dump_register]\n");
...
void bq24158_turn_on_charging(void)
{
    ...
    dprintf(CRITICAL, "[bq24158_turn_on_charging]\n");
    bq24158_reg_config_interface(0x00,0xC0);
    bq24158_reg_config_interface(0x01,0x78);
...
void bq24158_hw_init(void)
{
    ...
    dprintf(CRITICAL, "[bq24158_hw_init] (0x06,0x7a)\n");
    bq24158_reg_config_interface(0x06,0x7a); // set ISAFE and HW CV point (4.34)
    bq24158_reg_config_interface(0x02,0xb4); // 4.34    
#else
    dprintf(CRITICAL, "[bq24158_hw_init] (0x06,0x70)\n");
    bq24158_reg_config_interface(0x06,0x70); // set ISAFE
    bq24158_reg_config_interface(0x02,0x8e); // 4.2
#endif    
}
