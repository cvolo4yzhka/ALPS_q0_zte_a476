    ...
    // AF NVRAM
    {
        ...
        {
            {
                ...
                0,   // i4MacroIdxOffset          
                {
                    0, 10, 20,  30,  45,  60,  75,  95, 120, 145, 
        ...
        // -------------------- sAF_TH ---------------------
        {
			...
			{{21, 21, 20, 20, 20, 19, 19, 18},
			 {30, 30, 30, 30, 29, 29, 29, 27},
			 {44, 43, 43, 43, 43, 42, 42, 41},
            ...
            {1, 1, 1, 2, 2, 3, 4, 5},//{3, 3, 3, 4, 4, 5, 6, 8},//{4,4,5,6,7,7,8,12},
            ...
            {0, 0, 0, 1, 1, 1, 2, 3},//{3, 4, 4, 5, 5, 6, 6, 6},//{6, 6, 6, 8, 8, 8, 10, 14},//{9,9,9,9,10,10,11,13},
        },
        // ------------------- sZSDAF_TH -----------------------------------
        {
            8, // i4ISONum;
           {100, 150, 200, 300, 400, 600, 800, 1600},
            ...
            // SGG1~7
			{{20, 20, 19, 19, 18, 14, 17, 16},
			 {29, 29, 29, 28, 28, 23, 27, 25},
			 {43, 42, 42, 42, 41, 36, 40, 38},
			 {62, 61, 61, 61, 60, 55, 59, 57},
			 {89, 88, 88, 88, 87, 82, 86, 85},
			 {127, 126, 126, 126, 125, 122, 125, 123},
			 {180, 180, 180, 180, 179, 177, 179, 178}},
           ...
           // horizontal FV threshold
           {1, 1, 1, 2, 2, 3, 4, 5},//{4, 5, 6, 7, 8, 10, 11, 16},//{7,7,8,9,10,11,12,15},
           ...
           // vertical FV threshold
           {0, 0, 0, 1, 1, 2, 3, 4},//{4, 4, 5, 6, 7, 7, 8, 9},//{8, 9, 10, 12, 12, 14, 18, 26},//{11,12,14,17,20,22,24,25},
        },
        // -------------------- sVID_AF_TH ---------------------
        {
            0, // i4ISONum;
        ...
        { 
            ...
            0, 0, 30, 100, 90, 70, 0, 0, 0, 0,  // [41]~[50]
        }  // i4Coefs[100];
    },
    {//PD_NVRAM_T
