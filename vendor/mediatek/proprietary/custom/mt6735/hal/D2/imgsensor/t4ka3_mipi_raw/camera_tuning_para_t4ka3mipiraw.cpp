...
#include "camera_AE_PLineTable_t4ka3mipiraw.h"
#include "camera_info_t4ka3mipiraw.h"
...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    .ISPMulitCCM={
      .Poly22={
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            5922500, -3140000, -220000, -987500, 3937500, -387500, -20000, -2372500, 4952500
        },
        {  // i4P10[9]
            2545544, -2840944, 293904, -307505, 104233, 200318, 93880, 342270, -436150
        },
        {  // i4P01[9]
            1937900, -2293483, 349809, -436202, 10086, 423173, -23254, -254969, 278223
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        // rDevicesInfo
        {
            ...
            13273,    // u4VideoExpUnit  
            30,    // u4VideoMaxFrameRate 
            1024,    // u4Video2PreRatio, 1024 base = 1x 
            13273,    // u4CapExpUnit 
            30,    // u4CapMaxFrameRate
            1024,    // u4Cap2PreRatio, 1024 base = 1x
            13365,    // u4Video1ExpUnit
            30,    // u4Video1MaxFrameRate
            1024,    // u4Video12PreRatio, 1024 base = 1x
            13273,    // u4Video2ExpUnit
            30,    // u4Video2MaxFrameRate
            1024,    // u4Video22PreRatio, 1024 base = 1x
            13273,    // u4Custom1ExpUnit
            30,    // u4Custom1MaxFrameRate
            1024,    // u4Custom12PreRatio, 1024 base = 1x
            13273,    // u4Custom2ExpUnit
            30,    // u4Custom2MaxFrameRate
            1024,    // u4Custom22PreRatio, 1024 base = 1x
            13273,    // u4Custom3ExpUnit
            30,    // u4Custom3MaxFrameRate
            1024,    // u4Custom32PreRatio, 1024 base = 1x
            13273,    // u4Custom4ExpUnit
            30,    // u4Custom4MaxFrameRate
            1024,    // u4Custom42PreRatio, 1024 base = 1x
            13273,    // u4Custom5ExpUnit
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Warm fluorescent
                {
                    -192,    // PWFluoRightBound
                    -392,    // PWFluoLeftBound
                    -248,    // PWFluoUpperBound
                    -462    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -192,    // PIncaRightBound
            ...
            // AWB preference color	
            {
                ...
                // Sunset Area
                {
                    -16,   // i4Sunset_BoundXr_Thr
                    -335    // i4Sunset_BoundYr_Thr
                },
                // Sunset Vertex
                {
                    -16,   // i4Sunset_BoundXr_Thr
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, 
                    {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}, {520, 512, 530}
                }, // WARM F
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                ...
                {
                    {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, 
                    {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}, {530, 512, 512}
                }, // DAYLIGHT
                {
                    {512, 512, 510}, {512, 512, 510}, {512, 512, 510}, {512, 512, 510}, {512, 512, 510}, {512, 512, 510}, {512, 512, 510}, {512, 512, 510}, {512, 512, 510}, {512, 512, 510}, 
