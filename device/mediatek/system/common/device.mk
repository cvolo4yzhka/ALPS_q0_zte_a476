...
ifneq ($(strip $(MTK_GMO_RAM_OPTIMIZE)), yes)
    ...
    #VzW RSU components
    PRODUCT_PACKAGES += simlocktool_prod
    PRODUCT_PACKAGES += mediatek_wrongsign
    PRODUCT_PACKAGES += simlocktool_wrongpackage
    PRODUCT_PACKAGES += IOT_SIMLock_Preprod
    PRODUCT_PACKAGES += VZWRemoteSimlockService
    PRODUCT_PACKAGES += com.verizon.remoteSimlock.remotesimlockservicelibrary
    PRODUCT_PACKAGES += com.verizon.remoteSimlock.manager.remotesimlockmanagerlibrary
...
PRODUCT_PACKAGE_OVERLAYS += \
                           ...
                           device/mediatek/system/common/overlay/tcp
